...
<body>
  ...
  <div class="pagetitle">
      <h1>Setting Akun Hotel</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item">Form Akun</li>
          <li class="breadcrumb-item active">Setting Akun Hotel</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <form class="row g-3">
                ...
                <div class="col-md-6" style="height:50px">
                  <input type="text" class="form-control" placeholder="Alamat Hotel">
                </div>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">AKun Hotel</h5>
              <p>Edit Akun Hotel dari sini</a>.</p>
